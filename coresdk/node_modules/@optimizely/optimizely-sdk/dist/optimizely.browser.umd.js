(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function keyBy(arr, key) {
        if (!arr)
            return {};
        return lib_8(arr, function (item) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            return item[key];
        });
    }
    ...
    var createProjectConfig = function (datafileObj, datafileStr) {
        ...
        lib_5(projectConfig.rolloutIdMap || {}).forEach(function (rollout) {
        ...
        (projectConfig.experiments || []).forEach(function (experiment) {
            ...
            lib_5(experiment.variationKeyMap || {}).forEach(function (variation) {
        ...
        lib_5(projectConfig.featureKeyMap || {}).forEach(function (feature) {
        ...
        lib_6(projectConfig.flagRulesMap || {}).forEach(function (_a) {
            var flagKey = _a[0], rules = _a[1];
            var variations = [];
            rules.forEach(function (rule) {
                rule.variations.forEach(function (variation) {
                    if (!lib_7(variations, function (item) { return item.id === variation.id; })) {
    ...
    */
    var getFlagVariationByKey = function (projectConfig, flagKey, variationKey) {
        ...
        var result = lib_7(variations, function (item) { return item.key === variationKey; });
        if (result) {
            return result;
        }
        return null;
    ...
    var bucket = function (bucketerParams) {
        ...
        if (groupId) {
            ...
            if (!group) {
                throw new Error(lib_9(ERROR_MESSAGES.INVALID_GROUP_ID, MODULE_NAME$3, groupId));
            }
    ...
    var _generateBucketValue = function (bucketingKey) {
        try {
            ...
            throw new Error(lib_9(ERROR_MESSAGES.INVALID_BUCKETING_ID, MODULE_NAME$3, bucketingKey, ex.message));
        }
    };
    ...
    var DecisionService = /** @class */ (function () {
        ...
        DecisionService.prototype.removeForcedVariation = function (userId, experimentId, experimentKey) {
            if (!userId) {
                throw new Error(lib_9(ERROR_MESSAGES.INVALID_USER_ID, MODULE_NAME$7));
            }
            if (this.forcedVariationMap.hasOwnProperty(userId)) {
                ...
                throw new Error(lib_9(ERROR_MESSAGES.USER_NOT_IN_FORCED_VARIATION, MODULE_NAME$7, userId));
            }
        };
        /**
        ...
        if (typeof attributes === 'object' && !Array.isArray(attributes) && attributes !== null) {
            Object.keys(attributes).forEach(function (key) {
                if (typeof attributes[key] === 'undefined') {
                    throw new Error(lib_9(ERROR_MESSAGES.UNDEFINED_ATTRIBUTE, MODULE_NAME$9, key));
                }
            });
            return true;
        }
        else {
            throw new Error(lib_9(ERROR_MESSAGES.INVALID_ATTRIBUTES, MODULE_NAME$9));
        }
    }
    /**
    ...
    function validate$3(eventTags) {
        if (typeof eventTags === 'object' && !Array.isArray(eventTags) && eventTags !== null) {
            ...
            throw new Error(lib_9(ERROR_MESSAGES.INVALID_EVENT_TAGS, MODULE_NAME$a));
        }
    }
    ...
    function validate$4(userProfileServiceInstance) {
        if (typeof userProfileServiceInstance === 'object' && userProfileServiceInstance !== null) {
            if (typeof userProfileServiceInstance['lookup'] !== 'function') {
                throw new Error(lib_9(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$b, "Missing function 'lookup'"));
            }
            else if (typeof userProfileServiceInstance['save'] !== 'function') {
                throw new Error(lib_9(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$b, "Missing function 'save'"));
            }
            return true;
        }
        throw new Error(lib_9(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$b));
    }
    ...
    var Optimizely = /** @class */ (function () {
            ...
            try {
                if (stringInputs.hasOwnProperty('user_id')) {
                    ...
                    if (typeof userId !== 'string' || userId === null || userId === 'undefined') {
                        throw new Error(lib_9(ERROR_MESSAGES.INVALID_INPUT_FORMAT, MODULE_NAME$c, 'user_id'));
                    }
                    delete stringInputs['user_id'];
                }
                Object.keys(stringInputs).forEach(function (key) {
                    if (!validate$1(stringInputs[key])) {
                        throw new Error(lib_9(ERROR_MESSAGES.INVALID_INPUT_FORMAT, MODULE_NAME$c, key));
                    }
                });
                if (userAttributes) {
        ...
        Optimizely.prototype.getEnabledFeatures = function (userId, attributes) {
            ...
            try {
                ...
                lib_5(configObj.featureKeyMap).forEach(function (feature) {
        ...
        Optimizely.prototype.decide = function (user, key, options) {
            ...
            if (!feature) {
                ...
                return newErrorDecision(key, user, [lib_9(DECISION_MESSAGES.FLAG_KEY_INVALID, key)]);
            }
            ...
            if (shouldIncludeReasons) {
                reportedReasons = reasons.map(function (reason) { return lib_9.apply(void 0, __spreadArrays([reason[0]], reason.slice(1))); });
            }
            var featureInfo = {
                flagKey: key,
                enabled: flagEnabled,
    ...
    var NotificationCenter = /** @class */ (function () {
        ...
        function NotificationCenter(options) {
            ...
            lib_5(NOTIFICATION_TYPES).forEach(function (notificationTypeEnum) {
        ...
        NotificationCenter.prototype.addNotificationListener = function (notificationType, callback) {
            try {
                var notificationTypeValues = lib_5(NOTIFICATION_TYPES);
    ...
    function createHttpPollingDatafileManager(sdkKey, logger, datafile, datafileOptions) {
    ...
    var createInstance = function (config) {
        try {
            ...
            var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { eventProcessor: eventProcessor$1.createEventProcessor(eventProcessorConfig), logger: logger$6,
                errorHandler: errorHandler, datafileManager: config.sdkKey ? createHttpPollingDatafileManager(config.sdkKey, logger$6, config.datafile, config.datafileOptions) : undefined, notificationCenter: notificationCenter });
