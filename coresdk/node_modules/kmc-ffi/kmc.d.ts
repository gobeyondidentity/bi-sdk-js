...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_20778: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_20970: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_22532: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly __wasm_bindgen_func_elem_22497: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_22502: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_20789: (a: number, b: number) => void;
