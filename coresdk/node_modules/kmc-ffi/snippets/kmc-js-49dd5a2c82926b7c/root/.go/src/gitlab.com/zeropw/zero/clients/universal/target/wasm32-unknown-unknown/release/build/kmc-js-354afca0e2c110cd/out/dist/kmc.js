...
var device = $root.device = (() => {
  ...
  device2.DeviceInfo = function() {
    ...
    DeviceInfo.OSVersion = function() {
      ...
      OSVersion.prototype.release = null;
      ...
      OSVersion.encode = function encode(message, writer) {
        ...
        if (message.release != null && Object.hasOwnProperty.call(message, "release"))
          $root.device.StringMaybe.encode(message.release, writer.uint32(138).fork()).ldelim();
        return writer;
      };
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 12:
              ...
              break;
            case 17:
              message.release = $root.device.StringMaybe.decode(reader, reader.uint32());
              break;
            case 13:
      ...
      OSVersion.verify = function verify(message) {
        ...
        if (message.release != null && message.hasOwnProperty("release")) {
          let error = $root.device.StringMaybe.verify(message.release);
          if (error)
      ...
      OSVersion.fromObject = function fromObject(object) {
        ...
        if (object.release != null) {
          if (typeof object.release !== "object")
            throw TypeError(".device.DeviceInfo.OSVersion.release: object expected");
          message.release = $root.device.StringMaybe.fromObject(object.release);
        }
      ...
      OSVersion.toObject = function toObject(message, options) {
        ...
        if (message.release != null && message.hasOwnProperty("release"))
          object.release = $root.device.StringMaybe.toObject(message.release, options);
        return object;
      };
