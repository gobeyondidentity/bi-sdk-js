 ...
 */
export declare type IntegrityFailureError = {
    DateParse: string;
} | {
...
export declare type State = "Active" | "UserSuspended" | "UserDeleted" | "DeviceDeleted" | "Invalid";
...
export declare type UrlResponse = {
    type: "selfIssue";
    selfIssue: SelfIssueUrlResponse;
} | {
    type: "registration";
